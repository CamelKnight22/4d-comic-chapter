...
type ActionName = "page3" | "page4" | "page5" | "page7";
  interface GLTFAction extends THREE.AnimationClip {
    name: ActionName;}

    export function maddy(props: JSX.IntrinsicElements["group"]& { animation: ActionName }) {
      const group = useRef<THREE.Group>(null);
      const original = useGLTF("/maddy.glb") as GLTFResult;
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="root">
          ...
          <skinnedMesh
            name="Cylinder"
            geometry={(nodes.Cylinder as THREE.SkinnedMesh).geometry}
            material={materials.Shoes}
            skeleton={(nodes.Cylinder as THREE.SkinnedMesh).skeleton}
          />
          <skinnedMesh
            name="Eye_outer"
...
export const MemoMaddy = React.memo(maddy);
useGLTF.preload("/maddy.glb");