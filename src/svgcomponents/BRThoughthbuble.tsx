...
interface BRThoughthbubleProps {
  className?: string;
...
const BRThoughthbuble: React.FC<BRThoughthbubleProps> = ({ 
    ...
    return (
        <div className={`${className} absolute top-0 left-0`} style={containerStyle}>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" width="500" height="300" viewBox="0 0 500 300" xmlSpace="preserve" style={{ position: 'absolute', zIndex: 2, width: width, height: height }}>
                ...
                <defs></defs>
                <g
        transform="matrix(11.5516281977 0 0 6.1682923057 243.7948127577 132.7572854724)"
        id="Q9FQRb9C80189tShF0Awp"
      >
        <path
          style={{
            stroke: 'black',
          ...
          d="M 0 -20.29221 C 11.2013 -20.29221 20.29221 -11.201300000000002 20.29221 0 C 20.29221 11.2013 11.201300000000002 20.29221 0 20.29221 C -11.2013 20.29221 -20.29221 11.201300000000002 -20.29221 0 C -20.29221 -11.2013 -11.201300000000002 -20.29221 0 -20.29221 z"
          strokeLinecap="round"
        />
      ...
      <g
        transform="matrix(2.181323495 0 0 1.2534409195 405.346333035 264.6407649516)"
        id="K1kFrbSRagpYtV95dVHjP"
      >
        <path
          style={{
            stroke: 'black',
      ...
      <g
        transform="matrix(0.935898529 0 0 0.5377897939 472.1868213678 285.6423860506)"
        id="42oji9VrrJx0fmcZ2nouR"
      >
        <path
          style={{
            stroke: 'black',
      ...
      {/* Add more groups and paths as needed */}
    </svg>
        </div>
    );
};

export default BRThoughthbuble;
